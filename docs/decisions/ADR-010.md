...
> Step C-1's body PR may revise individual entries as the per-Engine-site
> translation table formalizes; UI shell terms below stay stable across
> that revision unless explicitly noted.
