...
| `docs/decisions/ADR-023.md`           | KMP Engine migration (Phase 3.0) — run-path Engine port to `commonMain`, callback-only K/N boundaries; Stage-2 gate **verdict GO 2026-07-18 (§12)** — Stage 3 unblocked *pending* its four conditions (incl. a duration re-estimate recorded on #501 before the first Stage-3 PR); Data stays Swift/GRDB (Status: Accepted; #501) |
