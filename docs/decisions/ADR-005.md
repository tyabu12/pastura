...
| 9 | App Store Connect Support URL landing page (§6.7) | [#182](https://github.com/tyabu12/pastura/issues/182) | tyabu12 | **Submission** | Filed 2026-04-21; `pages/support/index.html` deployed to `https://tyabu12.github.io/pastura/support/` |
...
This section records post-implementation policy changes to ADR-005.
Per CLAUDE.md "Decision Records", amendments use a top-level `§N`
heading rather than mutating the original section in place — this
preserves an audit trail of which decisions changed mid-flight and
why. The amended section retains a one-line pointer to the
corresponding amendment subsection here.
