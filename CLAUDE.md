...
- **Localization (i18n: ja/en)** — *in progress* — see ROADMAP § "Localization Plan" (#276/#277, ADR-010 stub #279, body #367)
...
| `docs/decisions/ADR-010.md`           | Localization (i18n: ja/en) — Step C-1 body (Status: Proposed; stub #279, body #367) |
