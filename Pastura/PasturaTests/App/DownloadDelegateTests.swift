...
struct DownloadDelegateTests {
  ...
  // Foreground-stranding regression tests for
  // `handleReattachedStreamTermination` live in
  // `DownloadDelegateTests+ForegroundStranding.swift` (sibling file —
  // keeps this suite under the 250-line type-body cap).
