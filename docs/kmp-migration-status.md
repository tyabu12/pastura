...
- **Stage 5** (iOS switch + code-merge): 🔄 in progress — the three deferred questions were ruled on
  ...
  ([#1681](https://github.com/tyabu12/pastura/issues/1681)) · soak pending
  ([runbook](qa/kmp-soak-qa.md)) · next: S5-4 soak → S5-5. See
