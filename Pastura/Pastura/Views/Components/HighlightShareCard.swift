...
/// 2. The app's `Color.*` aliases are trait-resolving for the 67 paired
///    §2.9 tokens (ADR-028 gate 1, closed by slice 4). Reading them here would make each family's colour
