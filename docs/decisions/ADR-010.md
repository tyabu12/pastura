...
| Try                     | 試す                     | Button — Share Board "try this scenario"                                 |
| Run / Run Simulation    | 実行 / シミュレーション実行 | Button — start simulation                                                |
| Pause                   | 一時停止                 | Button — during simulation                                               |
| Active                  | 使用中                   | Status — currently selected model (A-2 audit-list term, recorded for cross-PR consistency) |
| Ready                   | 利用可能                 | Status — downloaded but not active (A-2 audit-list term, same)           |
