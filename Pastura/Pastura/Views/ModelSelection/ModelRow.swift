...
struct ModelRow: View {
  ...
  /// `mossOnWash` over a `moss.opacity(0.12)` chip — `mossDark` was the
  /// original choice but measured ≈4.24:1 in light, under the 4.5:1 bar at
  /// this size; the role token reads ≈6.25:1 (#1327).
