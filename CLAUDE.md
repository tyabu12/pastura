...
- `i18n.md` — Swift-side localization **callsite** conventions, layer-independent: Form B `String(format: String(localized:))`, the Form A runtime-fallback hazard, partial-conversion orphans (`Pastura/Pastura/**/*.swift`, `Pastura/Pastura/Resources/Localizable.xcstrings`)
...
- `i18n-ui.md` — UI-layer i18n traps split out of `i18n.md` (#1431): plurals, the SwiftUI `LocalizedStringKey` traps, `#if DEBUG` extraction, Tier 2 audit triage / planning. Its § Scope carries the two-arm split criterion — read it before moving a section either way (`Pastura/Pastura/Views/**`, `Pastura/Pastura/App/**`, `Pastura/Pastura/PasturaApp.swift`, `Pastura/PasturaTests/Localization/**`, `Pastura/Pastura/Resources/Localizable.xcstrings`)
