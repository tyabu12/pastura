...
| `docs/decisions/ADR-022.md`           | Phase/event extension contract — declare once in the two Models enums (no registry); every Swift projection no-default exhaustive; forced-decision CI gates for non-Swift consumers (Status: Proposed; #993) |
