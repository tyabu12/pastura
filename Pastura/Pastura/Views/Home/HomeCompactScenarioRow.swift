...
/// icon tile, the scenario name, a one-line description, a
/// `provenance · N agents · N rounds` caption, and a trailing chevron. Lighter
/// and denser than the shared summary row it
