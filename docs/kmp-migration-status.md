...
- **Stage 5** (iOS switch + code-merge): 🔄 in progress — the three deferred questions were ruled on
  ...
  ([#1681](https://github.com/tyabu12/pastura/issues/1681)) — flag-gated Kotlin run path +
  translator + Pattern-6 VM re-audit; **soak pending** (operator cycle, runbook
  [`docs/qa/kmp-soak-qa.md`](qa/kmp-soak-qa.md)). **Next: S5-4 soak → S5-5**. See
