...
<!-- audit-data: {"date": "2026-06-20", "model": "gemma-4-E2B-it-Q4_K_M", "scenarios": {"word_wolf": {"coherence": 4, "interaction": 4, "breakdown_free": 5, "development": 4, "payoff": 3, "payoff_axis": "strategic_tension", "status": "ok"}}} -->

| id | name | channel | category | status | (a) | (b) | (c) | (d) development | (e) payoff | Δtotal | comment |
|---|---|---|---|---|---|---|---|---|---|---|---|
| word_wolf | ワードウルフ | preset | game_theory | ok | 4 | 4 | 5 | 4 | strategic_tension 3 | – | baseline |
