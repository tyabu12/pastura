...
/// the assertion belongs on the tint, not on any composite. Its ground list
/// is a **hand-maintained proxy**, not a derivation — a night ground added
/// later and darker than #0B0C0A would not automatically be covered here.
///
...
struct PasturaOccluderShadowsTests {
  ...
  private var entries: [PasturaShadow] {
    [
      PasturaOccluderShadows.modelPickerCard,
      PasturaOccluderShadows.modelPickerCTA,
      PasturaOccluderShadows.inFlightPill
    ]
  }
