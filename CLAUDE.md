...
- `i18n-ui.md` — UI-layer i18n traps: plurals, the SwiftUI `LocalizedStringKey` traps, `#if DEBUG` extraction, `.accessibilityLabel` audit triage. Its § Scope carries the split criterion (`Pastura/Pastura/Views/**`, `Pastura/Pastura/App/**`, `Pastura/Pastura/PasturaApp.swift`, `Pastura/PasturaTests/Localization/**`, `Pastura/Pastura/Resources/Localizable.xcstrings`)
