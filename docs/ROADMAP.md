...
| **B-1a: Store metadata + public pages** | App Store Connect metadata (description, keywords, screenshot captions) in ja and en; Japanese versions of `pages/index.html` (LP), `pages/support/`, and `pages/legal/privacy-policy/` (#369). | Required | Low | None (parallel with A) |
