...
| Wave B — 14 phase handlers | 🔄 4/14 | checklist ↓ |
| code-phase track | 🔄 | CP1 #1226 · CP2 #1230 (open) · CP3 RelationshipUpdate pending |
...
- [ ] ChooseHandler
- [ ] ConditionalHandler
- [ ] EventInjectHandler — #1230 (open)
- [ ] NarrateHandler
- [ ] ReflectHandler
- [ ] RelationshipUpdateHandler
- [ ] ScoreCalcHandler — #1230 (open)
- [ ] SpeakEachHandler
- [ ] VoteHandler
- [ ] WhisperHandler
