...
- `subagent-usage.md` — Subagent invocation discipline: 32K output token cap awareness (GitHub Issue #25569 / #24055), scope budget heuristics, Sonnet override rules. Always-loaded because subagent calls can originate from `/orchestrate`, slash commands, or any direct `Agent` tool invocation regardless of which file is being edited.
