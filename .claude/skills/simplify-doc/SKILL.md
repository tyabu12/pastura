...
- **`CLAUDE.md`'s ADR roster** must stay one line alone in its paragraph, and
  a reserved-ADR row (none today; ADR-006 was one until 2026-09-08) needs
  all three conjuncts of its table row. Both are read by
  `.claude/skills/consistency-audit/scripts/audit_docs.py`; a reflowed
