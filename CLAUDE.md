...
- `i18n-ui.md` — UI-layer i18n traps: plurals, the SwiftUI `LocalizedStringKey` traps, `#if DEBUG` extraction, `.accessibilityLabel` audit triage. Its § Scope carries the two-arm criterion splitting it from `i18n.md` (`Pastura/Pastura/Views/**`, `Pastura/Pastura/App/**`, `Pastura/Pastura/PasturaApp.swift`, `Pastura/PasturaTests/Localization/**`, `Pastura/Pastura/Resources/Localizable.xcstrings`)
