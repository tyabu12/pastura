...
| `docs/decisions/ADR-011.md`           | 6 GB RAM tier device support — selection criteria for 1B-class on-device models (no-go judgment for Gemma 3 1B IT + mechanism-contract prerequisites for future candidates; #477 / PR #480 / #483) |
